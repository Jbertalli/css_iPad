            ...
            <div style={{ transform: 'translate(0px, 0px)' }}> {/* rotate3d(2, -1, -1, 0.75turn) */}
                <div className={styles.front}> {/* style={{ width: '23.48vw' }} */}
                    <div className={styles.screen} style={{ transform: 'translate(12px, 16.2px)' }}>
                        ...
                        <div style={{ transform: 'translate(125px, 35px)' }}>
                            ...
                            { hour < 10 ? (
                                <>
                                    ...
                                    <div style={{ transform: 'translate(-13px, 4px)', fontSize: '13px', fontWeight: '300', color: 'white' }}>
                                        { today }
                                    </div>
                                </>
                            ) : (
                                <>
                                    <div style={{ transform: 'translate(5px)', fontSize: '50px', fontWeight: '100', marginBottom: '9px', color: 'white' }}>
                                        { time }
                                    </div>
                                    <div style={{ transform: 'translate(5px, 4px)', fontSize: '13px', fontWeight: '300', color: 'white' }}>
                                        { today }
                                    </div>
                                </>
                            )}
                        ...
                        <div style={{ transform: 'translate(245px, -80px) scale(.6)' }}>
                        ...
                        <div>
                            <div className={styles.frontPower} style={{ transform: 'translate(335px, -116px)' }} />
